...
export default function Process() {
  ...
  return (
    <section className="scroll-mt-20 py-14 sm:py-20 lg:py-24 bg-[#F5F7F8] border-b border-slate-200/60 relative overflow-hidden" id="how-we-work">
      <div className="max-w-[1440px] mx-auto px-4 sm:px-8 lg:px-12 xl:px-16">
        ...
        <div className="max-w-3xl mx-auto text-center mb-14 sm:mb-16">
          ...
          <h2 className="text-[32px] sm:text-[42px] font-extrabold text-[#172B55] tracking-tight mb-3 font-sans">
            From idea to production, <span className="text-[#2563EB]">together</span>.
          </h2>
          <p className="text-[16px] sm:text-[18px] text-[#506690] leading-[1.65] font-normal">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
          {steps.map((step, index) => (
            <motion.div
              ...
              className="bg-white rounded-2xl p-7 border border-slate-200/80 shadow-[0_4px_20px_rgba(23,43,85,0.03)] hover:shadow-[0_12px_30px_rgba(23,43,85,0.08)] hover:border-primary/50 transition-all duration-300 text-center flex flex-col items-center justify-between group"
            >
              <div className="flex flex-col items-center text-center">
                {/* Illustration Box */}
                <div className="mb-5 flex justify-center items-center transform group-hover:scale-105 transition-transform duration-300">
                  {step.illustration}
                </div>
